...
export { CrossValidate, FeedForward, NeuralNetwork, NeuralNetworkGPU, Recurrent, index$1 as activation, layer, layerTypes, likely, lookup, index as praxis, recurrent, utilities };
