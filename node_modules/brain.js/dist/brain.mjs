import { Input as Input$1, GPU, Texture, alias, utils } from 'gpu.js';
...
class BaseLayer {
    ...
    static toJSON(layer) {
        ...
        return {
            ...
            height: layer.height,
            depth: layer.depth,
            weights: toUntypedArray((weights && weights instanceof Texture
                ? weights.toArray()
                : weights)),
...
class NeuralNetworkGPU extends NeuralNetwork {
    ...
    buildCalculateDeltas() {
        ...
        calcDeltas = alias(utils.getMinifySafeName(() => calcDeltas), calcDeltas);
    ...
    run(input) {
        ...
        const output = outputTextures instanceof Texture
    ...
    toJSON() {
        ...
        const jsonLayerBiases = this.biases.map((layerBiases) => Array.from(layerBiases instanceof Texture
            ? layerBiases.toArray()
            : layerBiases));
        const jsonLayers = [];
        for (let i = 0; i <= this.outputLayer; i++) {
...
export { CrossValidate, FeedForward, NeuralNetwork, NeuralNetworkGPU, Recurrent, TrainStream, index$1 as activation, layer, layerTypes, likely, lookup, index as praxis, recurrent, utilities };
